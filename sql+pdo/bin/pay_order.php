...
function payOrder(int $orderId): void
{
    ...
    try {
        ...
        $updateOrderSql = "UPDATE orders SET status = 'paid', updated_at = NOW() WHERE id = :orderId AND status = 'new'";
        ...
        $paymentSql = "
            INSERT INTO payments (order_id, status, provider, created_at, updated_at) VALUES (:orderId, 'paid', 'stripe', NOW(), NOW())
        ";
